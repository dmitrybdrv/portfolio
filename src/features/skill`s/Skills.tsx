                ...
                <Slide direction={'right'}>
                    ...
                    <div className={style.skillWrapper}>
                        ...
                        <div className={style.skillsDescription}>
                            <p>
                                This is my hard skills set for today. Of course this is not the end of the list, because
                                i trying spend all of my free time to getting new information about new features,
                                technologies and programming tools. As i getting new skills, the list will be increase.
                            </p>
                        </div>
